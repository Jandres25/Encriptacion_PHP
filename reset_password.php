...
<body>
    <div class="container d-flex justify-content-center align-items-center">
        ...
        <div class="login-content">
            <form method="post" action="<?= APP_URL ?>/controlador/controlador_update_password.php">
                ...
                <input name="btnactualizar" class="btn mt-5" type="submit" value="ACTUALIZAR CONTRASEÑA">
            </form>
        </div>
    </div>
